...
[System.Serializable]
public struct NewTutorial
{
    public bool IsTutorial;
    public MonsterName[] Tutorial_MonsterName;
    public ObstacleName[] Tutorial_obstacle_name;
}
    ...
    public struct SubStage
    {
        ...
        public NewTutorial NewTutorial;
    ...
    public class StageManager : MonoBehaviour
    {
        ...
        public void SetObstacle(int Stage, int SubStage)
        {
            for (int i = 0; i < stage[Stage].subStage[SubStage].Object_Information.MyObstacle.Length; i++)
            {
                ...
                Obstacle obj = Instantiate(GameDB.Instance.GetObstacle(stage[Stage].subStage[SubStage].Object_Information.MyObstacle[i].obstacle_name),
                stage[Stage].subStage[SubStage].Object_Information.MyObstacle[i].obstacle_Pos,
                Quaternion.Euler(0, 0, stage[Stage].subStage[SubStage].Object_Information.MyObstacle[i].Angle)).GetComponent<Obstacle>();
